    ...
    <SectionContext.Provider value='tools'>
      ...
      <div className='mx-auto w-full max-w-[1400px] min-h-screen flex flex-col items-center'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 mx-4 md:mx-12'>
          <div
            className={`absolute lg:static top-10 lg:top-auto left-0 lg:left-auto mt-24 w-screen lg:w-auto h-full lg:h-auto bg-white lg:bg-transparent transition-transform lg:transform-none duration-300 lg:duration-0 ease-in-out overflow-y-auto ${isSidebarOpen ? '-translate-x-0' : '-translate-x-full'} z-5`}
          ...
          <main
            className={`md:col-span-3 lg:mt-20 lg:w-5/6 mx-4 md:mx-0 ${isSidebarOpen ? 'hidden lg:block' : ''}`}
          >
